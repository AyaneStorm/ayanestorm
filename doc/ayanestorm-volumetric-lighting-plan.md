...
For future shader edits, `shaderCacheRevision()` must be bumped whenever a volumetric GLSL source changes. Manual cache clearing during development is not a substitute for invalidation that remains correct in distributed builds.
