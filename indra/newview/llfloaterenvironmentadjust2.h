...
#ifndef LL_FLOATERENVIRONMENTADJUST2_H
#define LL_FLOATERENVIRONMENTADJUST2_H
 ...
 */
class LLFloaterEnvironmentAdjust2 : public LLFloater
{
    LOG_CLASS(LLFloaterEnvironmentAdjust2);

public:
                                LLFloaterEnvironmentAdjust2(const LLSD &key);
    virtual                     ~LLFloaterEnvironmentAdjust2();
...
#endif // LL_FLOATERFIXEDENVIRONMENT2_H
