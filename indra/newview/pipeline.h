...
protected:
    // <AS:Chanayane> Let the isolated volumetric module snapshot nearby local lights without exposing upstream light internals.
    friend class ASVolumetricLighting;
    // </AS:Chanayane>
