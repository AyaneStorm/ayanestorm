...
{
    const std::string strEnvFloaters[] = { "env_adjust_snapshot", "env_adjust_snapshot2", "env_edit_extdaycycle", "env_fixed_environmentent_sky", "env_fixed_environmentent_water", "my_environments" };
