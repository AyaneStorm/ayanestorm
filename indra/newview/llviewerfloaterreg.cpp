...
void LLViewerFloaterReg::registerFloaters()
{
    ...
    LLFloaterReg::add("env_adjust_snapshot2", "floater_adjust_environment2.xml", (LLFloaterBuildFunc)&LLFloaterReg::build<LLFloaterEnvironmentAdjust2>);
...
// [/RLVa:KB]
    ...
    LLFloaterReg::add(PHOTOTOOLS_FLOATER2, "floater_phototools2.xml", (LLFloaterBuildFunc)&LLFloaterReg::build<FloaterQuickPrefs>);
