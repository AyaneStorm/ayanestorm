...
#include "llfloaterenvironmentadjust2.h"
...
//=========================================================================
LLFloaterEnvironmentAdjust2::LLFloaterEnvironmentAdjust2(const LLSD &key):
    LLFloater(key)
{}

LLFloaterEnvironmentAdjust2::~LLFloaterEnvironmentAdjust2()
{}

//-------------------------------------------------------------------------
bool LLFloaterEnvironmentAdjust2::postBuild()
{
...
void LLFloaterEnvironmentAdjust2::onOpen(const LLSD& key)
{
    if (!mLiveSky)
    {
...
void LLFloaterEnvironmentAdjust2::onClose(bool app_quitting)
{
...
//-------------------------------------------------------------------------
void LLFloaterEnvironmentAdjust2::refresh()
{
...
void LLFloaterEnvironmentAdjust2::captureCurrentEnvironment()
{
...
void LLFloaterEnvironmentAdjust2::onButtonReset()
{
...
//-------------------------------------------------------------------------
void LLFloaterEnvironmentAdjust2::onAmbientLightChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjust2::onBlueHorizonChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjust2::onBlueDensityChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjust2::onHazeHorizonChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjust2::onHazeDensityChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjust2::onSceneGammaChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjust2::onCloudColorChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjust2::onCloudCoverageChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjust2::onCloudScaleChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjust2::onGlowChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjust2::onStarBrightnessChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjust2::onSunRotationChanged()
{
...
void LLFloaterEnvironmentAdjust2::onSunAzimElevChanged()
{
...
void LLFloaterEnvironmentAdjust2::onSunScaleChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjust2::onMoonRotationChanged()
{
...
void LLFloaterEnvironmentAdjust2::onMoonAzimElevChanged()
{
...
void LLFloaterEnvironmentAdjust2::onCloudMapChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjust2::onWaterMapChanged()
{
    if (!mLiveWater)
        return;
...
void LLFloaterEnvironmentAdjust2::onSunColorChanged()
{
    if (!mLiveSky)
        return;
...
void LLFloaterEnvironmentAdjust2::onReflectionProbeAmbianceChanged()
{
    if (!mLiveSky) return;
...
void LLFloaterEnvironmentAdjust2::updateGammaLabel()
{
    if (!mLiveSky) return;
...
void LLFloaterEnvironmentAdjust2::onEnvironmentUpdated(LLEnvironment::EnvSelection_t env, S32 version)
{
